class AndroidMirroring < Formula
  desc "Display and control your Android device"
  homepage "https://github.com/siddharth-coder8/Android-Mirroring.git"
  url "https://github.com/siddharth-coder8/Android-Mirroring/archive/refs/tags/Updates.tar.gz"
  ...
  resource "prebuilt-server" do
    url "https://github.com/siddharth-coder8/Android-Mirroring/archive/refs/tags/Updates.tar.gz", using: :nounzip
